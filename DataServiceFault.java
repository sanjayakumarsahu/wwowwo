...
public class DataServiceFault implements Serializable {
	...
	public DataServiceFault(String errorCode, String errorMessage) {
		super();
		this.errorCode = errorCode;
		this.errorMessage = errorMessage;
	}

	public DataServiceFault(String errorCode) {
		super();
		this.errorCode = errorCode;
	}

	public DataServiceFault(String errorCode,String message,String userMsg, String[] errors) {
		super();
		this.errorCode = errorCode;
	...
	public DataServiceFault(String type,String errorCode,String status,String message,String userMsg, String[] errors) {
		super();
		this.errorCode = errorCode;
		this.errorMessage = message;
		this.userMessage = userMsg;
	...
	public DataServiceFault(String type,String errorCode,String status,String message,String userMsg) {
		super();
		this.errorCode = errorCode;
		this.errorMessage = message;
		this.userMessage = userMsg;
	...
	public String toString() {
		return "DataServiceFault [status=" + status + ", errorCode="
